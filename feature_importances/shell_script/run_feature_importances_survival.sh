...
do
    ...
    do
        ...
        do 
            ...
            sbatch -J feature_importances/$TARGET/$MAIN_CATEGORY/$CATEGORY/elastic_net -o out/feature_importances/$TARGET/$MAIN_CATEGORY/$CATEGORY/elastic_net.out feature_importances/shell_script/unit_feature_importances.sh -mc $MAIN_CATEGORY -c $CATEGORY -a elastic_net -t $TARGET -rs 2 -nis 1000
