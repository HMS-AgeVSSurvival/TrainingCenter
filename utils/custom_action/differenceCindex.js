...
function reportCindexesExamination() {
    for (let idxTarget = 0; idxTarget < targets.length; idxTarget++) {
        ...
        reportCindexesMainCategory("examination", targets[idxTarget]);
    };
}


function reportCindexesLaboratoryAll() {
    reportCindexesMainCategory("laboratory", "all");
}


function reportCindexesLaboratoryCVD() {
    reportCindexesMainCategory("laboratory", "cvd");
}


function reportCindexesLaboratoryCancer() {
    reportCindexesMainCategory("laboratory", "cancer");
}
...
function reportCindexesQuestionnaire() {
    for (let idxTarget = 0; idxTarget < targets.length; idxTarget++) {
        ...
        reportCindexesMainCategory("questionnaire", targets[idxTarget]);
    };
}


function reportCindexesMainCategory(mainCategoryName, target) {
