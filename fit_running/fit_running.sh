...
[ ! -e out/$PATH_OUTPUTS/$ALGORITHM\_1.out ] && rm out/$PATH_OUTPUTS/$ALGORITHM\_1.out
[ ! -e out/$PATH_OUTPUTS/$ALGORITHM\_2.out ] && rm out/$PATH_OUTPUTS/$ALGORITHM\_2.out
...
[ ! -e out/$PATH_OUTPUTS/$ALGORITHM\_manager.out ] || rm out/$PATH_OUTPUTS/$ALGORITHM\_manager.out
