...
submission_run=$(sbatch -J run_200M_00:01:00 --partition short --array=1-2 --mem-per-cpu=200M --time 00:01:00 -o investigations/out/run_%a.out investigations/jobs/run.sh -m)
echo $submission_run
